...
import 'package:medcheck/features/home/data/datasources/verification_datasource_impl.dart';
import 'package:medcheck/features/home/data/repositories/verification_repository.dart';
import 'package:medcheck/features/home/domain/repositories/verification_repository_impl.dart';
...
Future<void> init() async {
  sl.registerFactory(() => AuthBloc(loginUser: sl(), signUpCustomer: sl()));
  ...
  sl.registerLazySingleton(() => VerificationBloc(verifyPack: sl()));
  sl.registerLazySingleton(() => VerifyPack(sl()));
  ...
  sl.registerLazySingleton<VerificationDatasource>(
      () => VerificationDatasourceImpl(sl(), sl())
  );
